...
export function WaterGlassesHandler({
  ...
  return (
    <ControlWaterGlassesContainer>
      <WaterGlassesRow>
        <TouchableOpacity onPress={handleDecreaseWaterGlasses} disabled={waterGlassesToAdd === 1}>
        ...
        <TouchableOpacity onPress={handleIncreaseWaterGlasses} disabled={waterGlassesToAdd >= 20}>
